...
internal class PreMoveVisitor : VisitorBase
{
    ...
    public override bool Visit(ChinChessJu chess, Position from, Position _)
    {
        ...
        bool MarkJu(ChinChessJu fromData, Position from, int rowStep, int columnStep)
        {
    ...
    public override bool Visit(ChinChessPao chess, Position from, Position _)
    {
        ...
        bool MarkPao(ChinChessPao fromData, Position from, int rowStep, int columnStep)
        {
            bool hasChoice = false;
    ...
    public override bool Visit(ChinChessMa chess, Position from, Position _)
    {
        ...
        bool MarkMa(ChinChessMa fromData, Position from, int rowStep, int columnStep)
        {
    ...
    public override bool Visit(ChinChessXiang chess, Position from, Position _)
    {
        ...
        bool MarkXiang(ChinChessXiang fromData, Position from, int rowStep, int columnStep)
        {
            int toRow = from.Row + rowStep, toColumn = from.Column + columnStep;
    ...
    public override bool Visit(ChinChessBing chess, Position from, Position _)
    {
        ...
        bool MarkBing(ChinChessBing fromData, Position from, int rowStep, int columnStep)
        {
            int toRow = from.Row + rowStep, toColumn = from.Column + columnStep;
    ...
    public override bool Visit(ChinChessShuai chess, Position from, Position _)
    {
        ...
        bool MarkShuai(ChinChessShuai fromData, Position from, int rowStep, int columnStep)
        {
            int toRow = from.Row + rowStep, toColumn = from.Column + columnStep;
