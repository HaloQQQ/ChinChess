...
{
    public class MoveCommand : ChinChessCommandBase, IChinChessCommand
    {
        ...
        public MoveCommand(int index, bool isRed, ChinChessModel from, ChinChessModel to, IList<ChinChessModel> list,
            ...
            : base(from, to)
        {
            ...
            _notation = ChinChessMovePathTranslator.ToNotation(new MovePath(From, To), (ChessType)_from.Data.Type, isRed, list);
